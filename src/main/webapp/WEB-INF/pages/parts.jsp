...
<table class="tg">
    ...
    <c:forEach items="${listParts}" var = "part">
        <tr>
            ...
            <td><a href="<c:url value='/edit/${part.id}'>  <c:param name="page" value="${page}"/><c:param name="viewParam" value="parts"/></c:url>">edit</a></td>
            <td><a href="<c:url value='/remove/${part.id}'> <c:param name="page" value="${page}"/><c:param name="viewParam" value="parts"/></c:url>">delete</a></td>
...
<div id="searchforms">
    ...
    <c:url var="addAction" value="/addPart" >
        <c:param name="page" value="${page}"/><c:param name="viewParam" value="parts"/>
    </c:url>
...
<div id = infoandreferences>
    ...
    <c:if test="${computerCount!=0}">
        ...
        <br/>
  <h2>  <a href="<c:url value='/requiredparts'> </c:url>">Show required parts</a>
<br/>
<br/>
